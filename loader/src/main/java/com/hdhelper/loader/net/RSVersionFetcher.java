...
// Looks up the current major revision of the oldschool game-client.
public class RSVersionFetcher {

    private static final int PORT = 43594;

    public static int getVersion(String serverHost, int initial_major, int timeout, int max_attempts) throws IOException {
        ...
        while(attempt < max_attempts) {
            ...
            socket = new Socket();
            socket.connect(new InetSocketAddress(serverHost, PORT), timeout);
