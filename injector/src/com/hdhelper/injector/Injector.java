...
import com.hdhelper.agent.bs.ResolverImpl;
import com.hdhelper.agent.bs.scripts.Client;
import com.hdhelper.agent.bs.scripts.GPI;
import com.hdhelper.agent.bs.scripts.RuneScript;
import com.hdhelper.agent.bs.scripts.cache.ItemDefinition;
import com.hdhelper.agent.bs.scripts.cache.NpcDefinition;
import com.hdhelper.agent.bs.scripts.cache.ObjectDefinition;
import com.hdhelper.agent.bs.scripts.collection.Deque;
import com.hdhelper.agent.bs.scripts.collection.DualNode;
import com.hdhelper.agent.bs.scripts.collection.Node;
import com.hdhelper.agent.bs.scripts.collection.NodeTable;
import com.hdhelper.agent.bs.scripts.entity.Entity;
import com.hdhelper.agent.bs.scripts.entity.GroundItem;
import com.hdhelper.agent.bs.scripts.entity.Npc;
import com.hdhelper.agent.bs.scripts.entity.Player;
import com.hdhelper.agent.bs.scripts.graphics.Image;
import com.hdhelper.agent.bs.scripts.ls.*;
import com.hdhelper.agent.bs.scripts.util.ItemTable;
import com.hdhelper.agent.bs.scripts.util.PlayerConfig;
import com.hdhelper.injector.io.ClientLoader;
...
public final class Injector {
    ...
    public Map<String,byte[]> inject() throws Exception {
        ...
        compiler.inject(com.hdhelper.agent.bs.scripts.entity.Character.class, classes);
